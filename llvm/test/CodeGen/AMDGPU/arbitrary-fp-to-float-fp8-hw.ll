...
; llvm.convert.from.arbitrary.fp on FP8ConversionInsts targets with OCP fp8/bf8
; semantics (gfx950+, gfx11+). gfx942 uses FNUZ semantics; see the companion
; test arbitrary-fp-to-float-fp8-fnuz-hw.ll.
...
; v3f32 (odd-width vector exercises split/widen legalization).
