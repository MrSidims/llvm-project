...
; CHECK-NEXT:    v_add_u32_e32 v4, 0x70, v0
; CHECK-NEXT:    v_lshlrev_b32_e32 v2, 21, v1
; CHECK-NEXT:    v_and_b32_e32 v3, 0x80000000, v3
; CHECK-NEXT:    v_lshlrev_b32_e32 v5, 23, v4
; CHECK-NEXT:    v_or3_b32 v2, v3, v5, v2
; CHECK-NEXT:    v_ffbh_u32_e32 v5, v1
; CHECK-NEXT:    v_sub_u32_e32 v6, 31, v5
; CHECK-NEXT:    v_lshlrev_b32_e64 v6, v6, 1
; CHECK-NEXT:    v_xor_b32_e32 v6, v1, v6
...
; CHECK-NEXT:    v_or3_b32 v5, v3, v5, v6
; CHECK-NEXT:    s_and_b64 s[4:5], s[4:5], vcc
; CHECK-NEXT:    v_cndmask_b32_e64 v2, v2, v5, s[4:5]
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], 31, v0
; CHECK-NEXT:    s_and_b64 vcc, s[4:5], vcc
; CHECK-NEXT:    s_xor_b64 s[8:9], vcc, -1
; CHECK-NEXT:    v_cmp_ne_u32_e64 s[6:7], 0, v0
; CHECK-NEXT:    s_and_b64 s[10:11], s[6:7], s[8:9]
; CHECK-NEXT:    s_movk_i32 s6, 0xfe
; CHECK-NEXT:    v_cmp_lt_u32_e64 s[6:7], s6, v4
; CHECK-NEXT:    v_or_b32_e32 v6, 0x7f800000, v3
; CHECK-NEXT:    s_and_b64 s[6:7], s[10:11], s[6:7]
; CHECK-NEXT:    v_or_b32_e32 v0, v0, v1
; CHECK-NEXT:    v_cmp_gt_i32_e64 s[8:9], 1, v4
; CHECK-NEXT:    v_cndmask_b32_e64 v2, v2, v6, s[6:7]
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[6:7], 0, v0
; CHECK-NEXT:    s_and_b64 s[8:9], s[10:11], s[8:9]
; CHECK-NEXT:    s_or_b64 s[6:7], s[6:7], s[8:9]
; CHECK-NEXT:    v_cndmask_b32_e64 v0, v2, v3, s[6:7]
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[6:7], 0, v1
; CHECK-NEXT:    s_and_b64 s[4:5], s[4:5], s[6:7]
; CHECK-NEXT:    v_mov_b32_e32 v5, 0x7fc00000
; CHECK-NEXT:    v_cndmask_b32_e64 v0, v0, v6, s[4:5]
...
; CHECK-NEXT:    v_add_u32_e32 v4, 0x78, v0
...
; CHECK-NEXT:    s_and_b64 s[8:9], s[4:5], s[6:7]
; CHECK-NEXT:    s_movk_i32 s4, 0xfe
; CHECK-NEXT:    v_cmp_lt_u32_e64 s[4:5], s4, v4
; CHECK-NEXT:    v_or_b32_e32 v6, 0x7f800000, v3
; CHECK-NEXT:    s_and_b64 s[4:5], s[8:9], s[4:5]
; CHECK-NEXT:    v_or_b32_e32 v0, v0, v1
; CHECK-NEXT:    v_cmp_gt_i32_e64 s[6:7], 1, v4
; CHECK-NEXT:    v_cndmask_b32_e64 v2, v2, v6, s[4:5]
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], 0, v0
; CHECK-NEXT:    s_and_b64 s[6:7], s[8:9], s[6:7]
; CHECK-NEXT:    s_or_b64 s[4:5], s[4:5], s[6:7]
; CHECK-NEXT:    v_mov_b32_e32 v5, 0x7fc00000
; CHECK-NEXT:    v_cndmask_b32_e64 v0, v2, v3, s[4:5]
; CHECK-NEXT:    v_cndmask_b32_e32 v0, v0, v5, vcc
; CHECK-NEXT:    s_setpc_b64 s[30:31]
...
; CHECK-NEXT:    v_add_u32_e32 v4, 0x7c, v0
; CHECK-NEXT:    v_lshlrev_b32_e32 v2, 21, v1
; CHECK-NEXT:    v_and_b32_e32 v3, 0x80000000, v3
; CHECK-NEXT:    v_lshlrev_b32_e32 v5, 23, v4
; CHECK-NEXT:    v_or3_b32 v2, v3, v5, v2
...
; CHECK-NEXT:    v_xor_b32_e32 v6, v1, v6
; CHECK-NEXT:    v_add_u32_e32 v7, -8, v5
; CHECK-NEXT:    v_sub_u32_e32 v5, 0x9a, v5
; CHECK-NEXT:    v_lshlrev_b32_e32 v6, v7, v6
; CHECK-NEXT:    v_lshlrev_b32_e32 v5, 23, v5
; CHECK-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v1
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], 0, v0
...
; CHECK-NEXT:    v_cmp_lt_u32_e64 s[4:5], s4, v4
; CHECK-NEXT:    v_or_b32_e32 v5, 0x7f800000, v3
; CHECK-NEXT:    s_and_b64 s[4:5], vcc, s[4:5]
; CHECK-NEXT:    v_or_b32_e32 v0, v0, v1
; CHECK-NEXT:    v_cmp_gt_i32_e64 s[6:7], 1, v4
; CHECK-NEXT:    v_cndmask_b32_e64 v2, v2, v5, s[4:5]
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], 0, v0
; CHECK-NEXT:    s_and_b64 s[6:7], vcc, s[6:7]
; CHECK-NEXT:    s_or_b64 vcc, s[4:5], s[6:7]
...
; CHECK-NEXT:    v_add_u32_e32 v4, 0x7e, v0
; CHECK-NEXT:    v_lshlrev_b32_e32 v2, 20, v1
; CHECK-NEXT:    v_and_b32_e32 v3, 0x80000000, v3
; CHECK-NEXT:    v_lshlrev_b32_e32 v5, 23, v4
; CHECK-NEXT:    v_or3_b32 v2, v3, v5, v2
...
; CHECK-NEXT:    v_xor_b32_e32 v6, v1, v6
; CHECK-NEXT:    v_add_u32_e32 v7, -8, v5
; CHECK-NEXT:    v_sub_u32_e32 v5, 0x9b, v5
; CHECK-NEXT:    v_lshlrev_b32_e32 v6, v7, v6
; CHECK-NEXT:    v_lshlrev_b32_e32 v5, 23, v5
; CHECK-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v1
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], 0, v0
...
; CHECK-NEXT:    v_add_u32_e32 v5, 0x7e, v1
; CHECK-NEXT:    v_lshlrev_b32_e32 v3, 22, v2
; CHECK-NEXT:    v_and_b32_e32 v4, 0x80000000, v4
; CHECK-NEXT:    v_lshlrev_b32_e32 v6, 23, v5
; CHECK-NEXT:    v_or3_b32 v3, v4, v6, v3
; CHECK-NEXT:    v_ffbh_u32_e32 v6, v2
; CHECK-NEXT:    v_sub_u32_e32 v7, 31, v6
; CHECK-NEXT:    v_lshlrev_b32_e64 v7, v7, 1
; CHECK-NEXT:    v_xor_b32_e32 v7, v2, v7
; CHECK-NEXT:    v_add_u32_e32 v8, -8, v6
; CHECK-NEXT:    v_sub_u32_e32 v6, 0x9d, v6
...
; CHECK-NEXT:    v_or3_b32 v6, v4, v6, v7
; CHECK-NEXT:    s_and_b64 vcc, vcc, s[4:5]
; CHECK-NEXT:    s_movk_i32 s4, 0xfe
; CHECK-NEXT:    v_cndmask_b32_e32 v0, v3, v6, vcc
; CHECK-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v1
; CHECK-NEXT:    v_cmp_lt_u32_e64 s[4:5], s4, v5
; CHECK-NEXT:    v_or_b32_e32 v3, 0x7f800000, v4
; CHECK-NEXT:    s_and_b64 s[4:5], vcc, s[4:5]
; CHECK-NEXT:    v_or_b32_e32 v1, v1, v2
; CHECK-NEXT:    v_cmp_gt_i32_e64 s[6:7], 1, v5
...
; CHECK-NEXT:    v_add_u32_e32 v8, 0x7e, v4
; CHECK-NEXT:    v_lshlrev_b32_e32 v6, 22, v5
; CHECK-NEXT:    v_and_b32_e32 v7, 0x80000000, v7
; CHECK-NEXT:    v_lshlrev_b32_e32 v9, 23, v8
; CHECK-NEXT:    v_or3_b32 v6, v7, v9, v6
; CHECK-NEXT:    v_ffbh_u32_e32 v9, v5
; CHECK-NEXT:    v_sub_u32_e32 v10, 31, v9
; CHECK-NEXT:    v_lshlrev_b32_e64 v10, v10, 1
; CHECK-NEXT:    v_xor_b32_e32 v10, v5, v10
; CHECK-NEXT:    v_add_u32_e32 v11, -8, v9
; CHECK-NEXT:    v_sub_u32_e32 v9, 0x9d, v9
; CHECK-NEXT:    v_and_b32_e32 v0, 1, v0
; CHECK-NEXT:    v_lshlrev_b32_e32 v10, v11, v10
; CHECK-NEXT:    v_lshlrev_b32_e32 v9, 23, v9
; CHECK-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v4
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], 1, v0
; CHECK-NEXT:    v_or3_b32 v9, v7, v9, v10
; CHECK-NEXT:    s_and_b64 vcc, vcc, s[4:5]
; CHECK-NEXT:    s_movk_i32 s8, 0xfe
; CHECK-NEXT:    v_cndmask_b32_e32 v0, v6, v9, vcc
; CHECK-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v4
; CHECK-NEXT:    v_cmp_lt_u32_e64 s[4:5], s8, v8
; CHECK-NEXT:    v_or_b32_e32 v6, 0x7f800000, v7
; CHECK-NEXT:    s_and_b64 s[4:5], vcc, s[4:5]
; CHECK-NEXT:    v_or_b32_e32 v4, v4, v5
; CHECK-NEXT:    v_cmp_gt_i32_e64 s[6:7], 1, v8
; CHECK-NEXT:    v_cndmask_b32_e64 v0, v0, v6, s[4:5]
...
; CHECK-NEXT:    v_or3_b32 v9, v7, v9, v10
; CHECK-NEXT:    s_and_b64 vcc, vcc, s[4:5]
; CHECK-NEXT:    v_cndmask_b32_e32 v1, v6, v9, vcc
; CHECK-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v4
; CHECK-NEXT:    v_cmp_lt_u32_e64 s[4:5], s8, v8
; CHECK-NEXT:    v_or_b32_e32 v6, 0x7f800000, v7
; CHECK-NEXT:    s_and_b64 s[4:5], vcc, s[4:5]
; CHECK-NEXT:    v_or_b32_e32 v4, v4, v5
; CHECK-NEXT:    v_cmp_gt_i32_e64 s[6:7], 1, v8
; CHECK-NEXT:    v_cndmask_b32_e64 v1, v1, v6, s[4:5]
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], 0, v4
; CHECK-NEXT:    s_and_b64 s[6:7], vcc, s[6:7]
; CHECK-NEXT:    s_or_b64 vcc, s[4:5], s[6:7]
