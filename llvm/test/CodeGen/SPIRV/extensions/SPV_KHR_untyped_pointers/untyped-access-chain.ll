...
; Test simple GEP with constant index
; Physical SPIR-V uses OpUntypedPtrAccessChainKHR
...
; Test GEP with i64 element type
; CHECK: OpFunction
; CHECK: OpUntypedPtrAccessChainKHR
...
; Test GEP with float element type
; CHECK: OpFunction
; CHECK: OpUntypedPtrAccessChainKHR
