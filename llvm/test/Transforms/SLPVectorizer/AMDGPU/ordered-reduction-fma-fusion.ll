...
; CHECK-NEXT:    [[IV13:%.*]] = load float, ptr addrspace(1) [[IP13]], align 4
; CHECK-NEXT:    [[MP13:%.*]] = getelementptr inbounds float, ptr addrspace(4) [[MASK]], i64 13
; CHECK-NEXT:    [[MV13:%.*]] = load float, ptr addrspace(4) [[MP13]], align 4
; CHECK-NEXT:    [[PROD13:%.*]] = fmul contract float [[IV13]], [[MV13]]
; CHECK-NEXT:    [[ACC13:%.*]] = fadd contract float [[ACC12]], [[PROD13]]
...
; CHECK-NEXT:    [[MP14:%.*]] = getelementptr inbounds float, ptr addrspace(4) [[MASK]], i64 14
; CHECK-NEXT:    [[MV14:%.*]] = load float, ptr addrspace(4) [[MP14]], align 4
; CHECK-NEXT:    [[PROD14:%.*]] = fmul contract float [[IV14]], [[MV14]]
; CHECK-NEXT:    [[ACC14:%.*]] = fadd contract float [[ACC13]], [[PROD14]]
...
; CHECK-NEXT:    [[TMP53:%.*]] = fmul contract float [[IV15]], [[MV15]]
...
; CHECK-NEXT:    [[IV16:%.*]] = load float, ptr addrspace(1) [[IP16]], align 4
; CHECK-NEXT:    [[MP16:%.*]] = getelementptr inbounds float, ptr addrspace(4) [[MASK]], i64 16
; CHECK-NEXT:    [[MV16:%.*]] = load float, ptr addrspace(4) [[MP16]], align 4
; CHECK-NEXT:    [[PROD16:%.*]] = fmul contract float [[IV16]], [[MV16]]
; CHECK-NEXT:    [[ACC16:%.*]] = fadd contract float [[ACC15]], [[PROD16]]
; CHECK-NEXT:    [[IP17:%.*]] = getelementptr inbounds float, ptr addrspace(1) [[INPUT]], i64 26
; CHECK-NEXT:    [[IV17:%.*]] = load float, ptr addrspace(1) [[IP17]], align 4
; CHECK-NEXT:    [[MP17:%.*]] = getelementptr inbounds float, ptr addrspace(4) [[MASK]], i64 17
; CHECK-NEXT:    [[MV17:%.*]] = load float, ptr addrspace(4) [[MP17]], align 4
; CHECK-NEXT:    [[PROD17:%.*]] = fmul contract float [[IV17]], [[MV17]]
; CHECK-NEXT:    [[ACC17:%.*]] = fadd contract float [[ACC16]], [[PROD17]]
; CHECK-NEXT:    [[IP18:%.*]] = getelementptr inbounds float, ptr addrspace(1) [[INPUT]], i64 27
; CHECK-NEXT:    [[IV18:%.*]] = load float, ptr addrspace(1) [[IP18]], align 4
; CHECK-NEXT:    [[MP18:%.*]] = getelementptr inbounds float, ptr addrspace(4) [[MASK]], i64 18
; CHECK-NEXT:    [[MV18:%.*]] = load float, ptr addrspace(4) [[MP18]], align 4
; CHECK-NEXT:    [[PROD18:%.*]] = fmul contract float [[IV18]], [[MV18]]
; CHECK-NEXT:    [[ACC18:%.*]] = fadd contract float [[ACC17]], [[PROD18]]
; CHECK-NEXT:    [[IP19:%.*]] = getelementptr inbounds float, ptr addrspace(1) [[INPUT]], i64 28
; CHECK-NEXT:    [[IV19:%.*]] = load float, ptr addrspace(1) [[IP19]], align 4
; CHECK-NEXT:    [[MP19:%.*]] = getelementptr inbounds float, ptr addrspace(4) [[MASK]], i64 19
; CHECK-NEXT:    [[MV19:%.*]] = load float, ptr addrspace(4) [[MP19]], align 4
; CHECK-NEXT:    [[PROD19:%.*]] = fmul contract float [[IV19]], [[MV19]]
; CHECK-NEXT:    [[ACC30:%.*]] = fadd contract float [[ACC18]], [[PROD19]]
...
; CHECK-NEXT:    [[TMP49:%.*]] = fmul contract float [[IV24]], [[MV24]]
...
; CHECK-NEXT:    [[IV21:%.*]] = load float, ptr addrspace(1) [[IP21]], align 4
; CHECK-NEXT:    [[MP21:%.*]] = getelementptr inbounds float, ptr addrspace(4) [[MASK]], i64 21
; CHECK-NEXT:    [[MV21:%.*]] = load float, ptr addrspace(4) [[MP21]], align 4
; CHECK-NEXT:    [[TMP50:%.*]] = fmul contract float [[IV21]], [[MV21]]
; CHECK-NEXT:    [[ACC21:%.*]] = fadd contract float [[ACC20]], [[TMP50]]
; CHECK-NEXT:    [[IP22:%.*]] = getelementptr inbounds float, ptr addrspace(1) [[INPUT]], i64 34
; CHECK-NEXT:    [[IV22:%.*]] = load float, ptr addrspace(1) [[IP22]], align 4
; CHECK-NEXT:    [[MP22:%.*]] = getelementptr inbounds float, ptr addrspace(4) [[MASK]], i64 22
; CHECK-NEXT:    [[MV22:%.*]] = load float, ptr addrspace(4) [[MP22]], align 4
; CHECK-NEXT:    [[TMP51:%.*]] = fmul contract float [[IV22]], [[MV22]]
...
; CHECK-NEXT:    [[IV23:%.*]] = load float, ptr addrspace(1) [[IP23]], align 4
; CHECK-NEXT:    [[MP23:%.*]] = getelementptr inbounds float, ptr addrspace(4) [[MASK]], i64 23
; CHECK-NEXT:    [[MV23:%.*]] = load float, ptr addrspace(4) [[MP23]], align 4
; CHECK-NEXT:    [[TMP52:%.*]] = fmul contract float [[IV23]], [[MV23]]
