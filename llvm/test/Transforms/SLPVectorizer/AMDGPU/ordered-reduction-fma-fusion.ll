...
; CHECK-NEXT:    [[TMP4:%.*]] = fmul contract float [[IV13]], [[MV13]]
...
; CHECK-NEXT:    [[TMP5:%.*]] = fmul contract float [[IV14]], [[MV14]]
...
; CHECK-NEXT:    [[TMP9:%.*]] = fmul contract float [[IV16]], [[MV16]]
...
; CHECK-NEXT:    [[TMP10:%.*]] = fmul contract float [[IV17]], [[MV17]]
...
; CHECK-NEXT:    [[TMP14:%.*]] = fmul contract float [[IV18]], [[MV18]]
...
; CHECK-NEXT:    [[TMP15:%.*]] = fmul contract float [[IV19]], [[MV19]]
...
; CHECK-NEXT:    [[TMP19:%.*]] = fmul contract float [[IV21]], [[MV21]]
...
; CHECK-NEXT:    [[TMP20:%.*]] = fmul contract float [[IV22]], [[MV22]]
...
; CHECK-NEXT:    [[TMP24:%.*]] = fmul contract float [[IV23]], [[MV23]]
...
; CHECK-NEXT:    [[TMP25:%.*]] = fmul contract float [[IV24]], [[MV24]]
